...
public class TicketCheckoutAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // secara default, kita harus hide btnmines
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                lokasi.setText(dataSnapshot.child("nama_wisata").getValue().toString());
                ketentuan.setText(dataSnapshot.child("nama_wisata").getValue().toString());

                date_wisata =dataSnapshot.child("nama_wisata").getValue().toString();
                time_wisata =dataSnapshot.child("nama_wisata").getValue().toString();
